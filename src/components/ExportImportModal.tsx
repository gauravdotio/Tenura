...
export const ExportImportModal: React.FC<ExportImportModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="w-full max-w-lg rounded-2xl bg-[#0E121E] border border-white/[0.09] shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="p-5 border-b border-white/[0.06] bg-[#090D16] flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Export structured CSV/JSON archives or restore records</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 p-3 rounded-xl bg-slate-900 hover:bg-slate-850 border border-white/[0.08] text-white text-xs font-semibold transition-all hover:border-indigo-500/40"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 p-3 rounded-xl bg-slate-900 hover:bg-slate-850 border border-white/[0.08] text-white text-xs font-semibold transition-all hover:border-emerald-500/40"
              >
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-md shadow-indigo-600/30 transition-all flex items-center justify-center gap-2"
            >
        ...
        {/* Footer */}
        <div className="p-4 bg-[#090D16] border-t border-white/[0.06] flex justify-end">
          <button
            onClick={onClose}
